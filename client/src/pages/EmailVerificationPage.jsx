						...
						<div className="flex justify-between">
							{code.map((digit, index) => (
								<input
									...
									className="w-12 h-12 sm:w-14 sm:h-14 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-gray-600 rounded-lg focus:border-green-500 focus:outline-none"
								/>
							))}
						</div>
